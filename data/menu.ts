...
export const menu: Record<string, Dish[]> = {
  ...
  entradas: [
    ...
    { id: "wonton", name: "Wonton Tacos", description: "Tacos crujientes de wonton con col morada, zanahoria rallada y salsa de soja.", price: 420, category: "entradas" },
    { id: "burrata", name: "Burrata", description: "Burrata artesanal con tomate heirloom, albahaca fresca y reducción balsámica.", price: 450, tags: ["vegetariano"], category: "entradas" },
    ...
    { id: "dumplings", name: "Dumplings de Cerdo", description: "Dumplings al vapor con relleno de cerdo y chalota, acompañados de salsa de soja.", price: 410, category: "entradas" },
